...
int main(int argc, char* argv[]) {
    ...
    {   
        ...
        csvFile << fileName << "," << "OprimizedMedian" << "," << crossingsS << "," << duration2 << "," << crossingsN << "," << duration << "," << numEdges << "," << numVertices << "," << graph.countCrossingsSweep(graph.getA(), OptimizedMedian.getNewB()) << std::endl;
