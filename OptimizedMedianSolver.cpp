...
int main(int argc, char* argv[]) {
    ...
    {   
        ...
        csvFile << fileName << "," << "OptimizedMedian" << "," << crossingsS << "," << duration << "," << numEdges << "," << numVertices << "," << graph.calculateGraphDensity() << "," << graph.countCrossingsSweep(graph.getA(), OptimizedMedian.getNewB()) << std::endl;
