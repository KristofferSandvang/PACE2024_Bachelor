...
int main(int argc, char* argv[]) {
    ...
    {   
        ...
        csvFile << fileName << "," << "Barycenter" << "," << crossingsS << "," << duration << "," << numEdges << "," << numVertices << "," << graph.calculateGraphDensity() << "," << graph.countCrossingsSweep(graph.getA(), barycenter.getNewB()) << std::endl;
