...
int main(int argc, char* argv[]) {
    ...
    {   
        ...
        csvFile << fileName << "," << "OptimizedBC" << "," << crossingsS << "," << duration2 << "," << crossingsN << "," << duration << "," << numEdges << "," << numVertices << "," << graph.countCrossingsSweep(graph.getA(), optimizedBC.getNewB()) << std::endl;
