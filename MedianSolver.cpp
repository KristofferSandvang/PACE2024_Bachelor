...
int main(int argc, char* argv[]) {
    ...
    {   
        ...
        csvFile << fileName << "," << "Median" << "," << crossingsS << "," << duration << "," << numEdges << "," << numVertices << "," << graph.calculateGraphDensity() << "," << graph.countCrossingsSweep(graph.getA(), Median.getNewB()) << std::endl;
